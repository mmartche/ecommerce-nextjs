...
var shipping_module_1 = require("../shipping/shipping.module");
...
var OrdersModule = function () {
    ...
    var _classThis;
    var OrdersModule = _classThis = /** @class */ (function () {
        function OrdersModule_1() {
        }
        return OrdersModule_1;
    }());
    __setFunctionName(_classThis, "OrdersModule");
    (function () {
