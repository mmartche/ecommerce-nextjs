...
var OrdersController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/orders'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var OrdersController = _classThis = /** @class */ (function () {
        ...
        OrdersController_1.prototype.create = function (request, dto) {
            return this.ordersService.create(request.user.id, dto);
        };
        OrdersController_1.prototype.findAll = function (request) {
            return this.ordersService
                .findAllByUser(request.user.id);
        };
        OrdersController_1.prototype.findOne = function (request, id) {
            return this.ordersService
                .findOneByUser(request.user.id, id);
        };
