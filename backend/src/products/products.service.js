            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            products = _a.sent();
                            return [2 /*return*/, products.map(function (product) { return (__assign(__assign({}, product), { colors: product.colors.map(function (item) { return item.color; }), fonts: product.fonts.map(function (item) { return item.font; }) })); })];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, __assign(__assign({}, product), { colors: product.colors.map(function (item) { return item.color; }), fonts: product.fonts.map(function (item) { return item.font; }) })];
                    }
                });
            });
        };
